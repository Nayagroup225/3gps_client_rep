...
public class MainService extends Service implements IApiCallback<BaseRes>, LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (mLastKnownLocation != null) {
                                if (AppSharedPreference.getInstance(getApplicationContext()).getGpsState().equals("1")) {
                                    ...
                                    ApiCall.getInstance().sendCurrentPosition(preferences.getDeviceId(), String.valueOf(mLastKnownLocation.getLatitude()), String.valueOf(mLastKnownLocation.getLongitude()), MainService.this);
                                }
                            }
                        } else {
...
//                lastSentPositionTime = System.currentTimeMillis();
                ...
                ApiCall.getInstance().sendCurrentPosition(preferences.getDeviceId(), String.valueOf(location.getLatitude()), String.valueOf(location.getLongitude()), MainService.this);
//            }
        }
    }
